...
static void handler_socks_conn(struct event_base *base, int fd, u_int16_t flags,
                               void *data)
{
...
void handler_socks(struct event_base *base, int fd, u_int16_t flags, void *data)
{
    struct socks_conn *c;
